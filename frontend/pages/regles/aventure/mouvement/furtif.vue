<template>
  <main class="container">
    ...
    <p>Une créature peut se faire furtive lorsqu’elle se déplace ou se tient dans une zone n’étant pas complètement dégagée.</p>
    <p>
...
const title: string = "Déplacement furtif";
