...
const title: string = "Chargement";

useSeo({
  title,
  description: "Découvrez la règle du chargement : insérez une munition dans une arme et améliorez cette action grâce au talent Chargement rapide.",
});
</script>
