...
const title: string = "Encombré";

useSeo({
  title,
  description: "Découvrez l’état d’encombrement : une créature portant trop de poids subit une réduction de sa vitesse de déplacement.",
});
</script>
