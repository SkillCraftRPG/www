<template>
  <div>
    ...
    <p>
      ...
      <NuxtLink to="/regles/magie/pouvoirs/liberte">Liberté</NuxtLink> (<i>Sauterelle</i>) en
      <NuxtLink to="/regles/magie/parametres/portee">se désignant comme cible</NuxtLink>. Une fois par jour, il peut également canaliser le niveau 3 du pouvoir
      <NuxtLink to="/regles/magie/pouvoirs/liberte">Liberté</NuxtLink> en se désignant comme cible.
    </p>
