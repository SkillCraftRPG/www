<template>
  <section>
    ...
    <ul>
      <li>
        <a href="#tiers-1">Infusions de tiers 1</a>
        <ul>
          <li>
            <a href="#armure-athletique">Armure athlétique</a>
          </li>
          <li>
            <a href="#balistique">Balistique</a>
          </li>
          <li>
      ...
      <li>
        <a href="#tiers-2">Infusions de tiers 2</a>
        <ul>
          <li>
            <a href="#amplificateur-magique">Amplificateur magique</a>
          </li>
          <li>
            <a href="#anneau-energetique">Anneau énergétique</a>
          </li>
          <li>
            <a href="#arme-etincelante">Arme étincelante</a>
          </li>
          <li>
