<template>
  <main class="container">
    ...
    <p>
      Le maître de jeu détermine le degré de difficulté avant que le test ne soit effectué, ou pendant, mais avant d’en connaître le résultat, favorisant ainsi
