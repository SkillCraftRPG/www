...
const title: string = "Pas prudent";

useSeo({
  title,
  description: "Découvrez l’action Pas prudent : déplacez-vous de 1,5 mètre sans déclencher d’attaque d’opportunité, sauf en terrain difficile.",
});
</script>
