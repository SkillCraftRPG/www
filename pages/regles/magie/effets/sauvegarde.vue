...
const title: string = "Jets de sauvegarde";

useSeo({
  title,
  description: "Découvrez comment les jets de sauvegarde permettent de résister aux pouvoirs, réduisant ou annulant leurs effets selon le degré de difficulté.",
});
</script>
