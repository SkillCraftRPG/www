...
{
  public static IServiceCollection AddSkillCraftSwagger(this IServiceCollection services, AdminSettings settings)
  {
  ...
  public static void UseSkillCraftSwagger(this IApplicationBuilder builder, AdminSettings settings)
  {
    builder.UseSwagger();
