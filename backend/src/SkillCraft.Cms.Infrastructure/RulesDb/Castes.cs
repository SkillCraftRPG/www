...
{
  public static readonly TableId Table = new(RulesContext.Schema, nameof(RulesContext.Castes), alias: null);
  ...
  public static readonly ColumnId FeatureId = new(nameof(CasteEntity.FeatureId), Table);
  public static readonly ColumnId FeatureUid = new(nameof(CasteEntity.FeatureUid), Table);
  public static readonly ColumnId Id = new(nameof(CasteEntity.Id), Table);
  public static readonly ColumnId IsPublished = new(nameof(CasteEntity.IsPublished), Table);
  public static readonly ColumnId MetaDescription = new(nameof(CasteEntity.MetaDescription), Table);
  ...
  public static readonly ColumnId SlugNormalized = new(nameof(CasteEntity.SlugNormalized), Table);
