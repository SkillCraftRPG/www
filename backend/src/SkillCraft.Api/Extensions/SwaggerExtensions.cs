...
{
  public static IServiceCollection AddSkillCraftApiSwagger(this IServiceCollection services, ApiSettings settings)
  {
  ...
  public static void UseSkillCraftApiSwagger(this IApplicationBuilder builder, ApiSettings settings)
  {
    builder.UseSwagger();
