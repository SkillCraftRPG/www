...
internal abstract class RuleCompilerTask : ICommand
{
  /// <summary>
  ...
  protected RuleCompilerTask(string? description = null, string? nameOverride = null, Guid? id = null, DateTime? startedOn = null)
  {
    Id = id ?? Guid.NewGuid();
  ...
  public override bool Equals(object? obj) => obj is RuleCompilerTask task && task.GetType().Equals(GetType()) && task.Id == Id;
